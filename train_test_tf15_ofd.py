...
# Demo:
# cd ${TFTMP}/csv
# ${HOME}/anaconda3/bin/python ${TF}/train_test_tf15_ofd.py $STARTYR $ENDYR
# tail ${TFTMP}/csv/predictions_tf15_ofd_2016.csv
...
for yr in range(startyr,1+finalyr):
  ...
  # I changed my mind:
  x_train_a = train_a[:,wday_i:end_i] # Ordinal features.
  ...
  # I changed my mind:
  x_test_a = test_a[:,wday_i:end_i] # Ordinal features.
