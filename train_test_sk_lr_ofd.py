...
# Demo:
# cd ${TFTMP}/csv
# ${HOME}/anaconda3/bin/python ${TF}/train_test_sk_lr_ofd.py $STARTYR $ENDYR
# tail ${TFTMP}/csv/predictions_sk_lr_ofd_2016.csv

# I use this model to test sklearn logistic regression on ordinal features built from dates:
model_name = 'sk_lr_ofd'
...
for yr in range(startyr,1+finalyr):
  ...
  x_train_a  = train_a[:,wday_i:end_i] # Machine should learn from this.
